...
@section('content')
    ...
    <div class="small-container single-product" >
        <div class="row">
            <div class="col-2">
                <img src="{{ asset ('imgs/spanishB.jpg') }}" width="100%" id="ProductImg">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="{{ asset ('imgs/spanishB.jpg') }}" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="{{ asset ('imgs/spanishB2.jpg') }}" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
            ...
            <div class="col-2">
                <h1> Special Spanish Bread (10's) </h1>
                <h4>₱399.00</h4>
                @include('include.order')
                <h3>Product Detail</h3>
                <br>
                <p>Transport yourself to the sunny streets of Spain with a taste of Spanish Bread.</p>
            </div>
        </div>
    </div>
<br><br>
