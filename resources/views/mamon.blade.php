...
@section('content')
    ...
    <div class="small-container single-product" >
        <div class="row">
            <div class="col-2">
                <img src="{{ asset ('imgs/mamon.jpg') }}" width="100%" id="ProductImg">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="{{ asset ('imgs/mamon.jpg') }}" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
            ...
            <div class="col-2">
                ...
                <br>
                <p>Is a delightful dessert that embodies the warmth and sweetness of Filipino cuisine</p>
            </div>
        </div>
    </div>
<br><br>
