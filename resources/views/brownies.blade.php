...
@section('content')
    ...
    <div class="small-container single-product" >
        <div class="row">
            <div class="col-2">
                <img src="{{ asset ('imgs/brownies.jpg') }}" width="100%" id="ProductImg">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="{{ asset ('imgs/brownies2.jpg') }}" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="{{ asset ('imgs/brownies.jpg') }}" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
            ...
            <div class="col-2">
                ...
                <br>
                <p>Grab a Brownie, and let its rich fudgy goodness transport you to a world of Chocolatey bliss.</p>
            </div>
        </div>
    </div>
<br><br>
