...
@section('content')
    ...
    <div class="small-container single-product" >
        <div class="row">
            <div class="col-2">
                <img src="{{ asset ('imgs/sufle.jpg') }}" width="100%" id="ProductImg">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="{{ asset ('imgs/sufle.jpg') }}" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="{{ asset ('imgs/sufle2.jpg') }}" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
            ...
            <div class="col-2">
                <h1> Chocolate Souffle (4's) </h1>
                <h4>₱199.00</h4>
                @include('include.order')
                <h3>Product Detail</h3>
                <br>
                <p>A Chocolate Souffle is a true delight for chocolate lovers,
                    be prepared to fall in love with its irresistible taste and texture</p>
            </div>
        </div>
    </div>
<br><br>
