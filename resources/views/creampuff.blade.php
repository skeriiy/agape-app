...
@section('content')
    ...
    <div class="small-container single-product" >
        <div class="row">
            <div class="col-2">
                <img src="{{ asset ('imgs/banana.jpg') }}" width="100%" id="ProductImg">
                
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="{{ asset ('imgs/banana.jpg') }}" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="{{ asset ('imgs/banana2.jpg') }}" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="{{ asset ('imgs/banana3.jpg') }}" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
            ...
            <div class="col-2">
                ...
                <br>
                <p>Prepare to be enchanted by the Creampuff a delectable treat that melts in your Mouth.</p>
            </div>
        </div>
    </div>
<br><br>
